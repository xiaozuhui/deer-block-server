    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('origin', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='origin_issues', to='square.issues', verbose_name='原动态')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('medias', models.ManyToManyField(to='media.File', verbose_name='图片和视频')),
                ('publisher', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to=settings.AUTH_USER_MODEL, verbose_name='回复者')),
