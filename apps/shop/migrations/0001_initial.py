    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('art',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='artwork.art', verbose_name='艺术品')),
            ...
            bases=(models.Model, apps.interfaces.can_share.CanShare, apps.interfaces.can_collection.CanCollection,
                   apps.interfaces.can_thumbup.CanThumbUp, apps.interfaces.can_comment.CanComment),
            managers=[
